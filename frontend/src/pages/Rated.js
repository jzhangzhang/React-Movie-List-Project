...
import { getFavMovieList, getRatedMovies, markFavoriteMovie } from "../utils/fetchFromAPI";
...
export default function Rated() {
    ...
    return (<div>
        <Grid2 container>
            ...
            <Grid2 xs={12}>
                <MovieCardList movies={ratedMovies} likedMoviesMap={likedMoviesMap} onToggleLike={handleToggleLike} />
            </Grid2>
        </Grid2>
    </div>);
}